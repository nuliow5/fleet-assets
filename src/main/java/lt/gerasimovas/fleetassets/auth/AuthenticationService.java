...
import lt.gerasimovas.fleetassets.configs.JwtService;
import lt.gerasimovas.fleetassets.entities.UserEntity;
import lt.gerasimovas.fleetassets.enumes.TokenType;
import lt.gerasimovas.fleetassets.repositories.TokenRepository;
...
//                .build();
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        UserEntity userEntity = userEntityRepository.findByEmail(request.getEmail()).get();
        var jwtToken = jwtService.generateToken(userEntity);
        var refreshToken = jwtService.generateRefreshToken(userEntity);
    ...
    public void refreshToken(
        ...
        if (userEmail != null) {
            var user = this.userEntityRepository.findByEmail(userEmail)
                    .orElseThrow();
